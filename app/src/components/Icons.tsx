...
export const IconCopy = memo(function IconCopy({ className = '', size = 16 }: IconProps) {
  return (
...
export const IconCheck = memo(function IconCheck({ className = '', size = 16 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className} width={size} height={size}>
...
export const IconPlus = memo(function IconPlus({ className = '', size = 20 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className} width={size} height={size}>
...
export const IconMenu = memo(function IconMenu({ className = '', size = 24 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className} width={size} height={size}>
...
export const IconX = memo(function IconX({ className = '', size = 24 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className} width={size} height={size}>
...
export const IconSettings = memo(function IconSettings({ className = '', size = 20 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className} width={size} height={size}>
...
export const IconSun = memo(function IconSun({ className = '', size = 20 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className} width={size} height={size}>
...
export const IconMoon = memo(function IconMoon({ className = '', size = 20 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className} width={size} height={size}>
...
export const IconRefresh = memo(function IconRefresh({ className = '', size = 16 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className} width={size} height={size}>
...
export const IconTrash = memo(function IconTrash({ className = '', size = 16 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className} width={size} height={size}>
...
export const IconMessage = memo(function IconMessage({ className = '', size = 16 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className} width={size} height={size}>
